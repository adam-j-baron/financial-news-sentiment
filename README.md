...
A production-ready system for analyzing sentiment in financial news using state-of-the-art language models. This project was generated by an AI Agent (Claude Sonnet 3.5 in GitHub Copilot) using the provided `prompt.md` and prototype notebook in the `/prototype` folder.
